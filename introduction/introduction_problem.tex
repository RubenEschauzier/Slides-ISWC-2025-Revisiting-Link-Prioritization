\begin{frame}{The Need for Decentralized Personal Data Storage}
    \begin{columns}[T] % T aligns columns at the top
        ...
        \begin{column}{0.6\textwidth} % Adjust width as needed
            \includegraphics[width=\linewidth]{images/current-bad-message-situation.pdf} % replace with your image file
        \end{column}
...
\begin{frame}{The Need for Decentralized Personal Data Storage}
    \begin{columns}[T] % T aligns columns at the top
        % Left column: Image
        \begin{column}{0.6\textwidth} % Adjust width as needed
            \includegraphics[width=\linewidth]{images/decentralized-message-storage.pdf} % replace with your image file
        \end{column}
